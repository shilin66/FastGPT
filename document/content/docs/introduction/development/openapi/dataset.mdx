---
title: 知识库接口
description: OmniCockpit OpenAPI 知识库接口
---
...
--data-raw '{
    "datasetId": "知识库 ID",
    "name": "可选，自定义订单名称，例如：文档训练-OmniCockpit.docx"
}'
```
...
| autoIndexes      | 是否自动生成索引                                                                              |      |
| imageIndex       | 是否自动生成图片索引                                                                         |      |
...
--header 'Content-Type: application/json' \
--data-raw '{
    "link":"https://localhost:3000/docs/course/quick-start/",
    "datasetId":"6593e137231a2be9c5603ba7",
    "parentId": null,
...
--header 'Authorization: Bearer {{authorization}}' \
--form 'file=@"C:\\Users\\user\\Desktop\\OmniCockpit测试文件\\index.html"' \
...
--header 'Content-Type: application/json' \
--data-raw '{
    "externalFileUrl":"https://image.xxxxx.com/dev/%E6%91%82.pdf",
    "externalFileId":"1111",
  ...
  "data": {
    "list": [
      ...
      },
      {
        ...
        "tmbId": "65422be6aa44b7da77729ec9",
        "type": "link",
        "name": "快速上手 | OmniCockpit",
        "rawLink": "http://localhost:3000/docs/course/quick-start/",

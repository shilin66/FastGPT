---
title: 飞书知识库
description: OmniCockpit 飞书知识库功能介绍和使用方式
---
...
OmniCockpit v4.8.16 版本开始，商业版用户支持飞书知识库导入，用户可以通过配置飞书应用的 appId 和 appSecret，并选中一个**文档空间的顶层文件夹**来导入飞书知识库。目前处于测试阶段，部分交互有待优化。

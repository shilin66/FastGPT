---
title: '长字幕翻译'
description: '利用 AI 自我反思提升翻译质量，同时循环迭代执行 AI 工作流来突破 LLM tokens 限制，实现一个高效的长字幕翻译机器人。'
icon: 'translate'
draft: false
toc: true
weight: 604
...
本案例将展示如何利用 ZenMeta 工作流代码结合 LLM 来有效解决这些问题。我们的方法不仅能克服技术限制，还能显著提升翻译质量。
...
本工作流完整配置如下，可直接复制，导入到 ZenMeta 中。

---
title: '知识库接口'
description: 'ZenMeta OpenAPI 知识库接口'
icon: 'dataset'
draft: false
toc: true
weight: 853
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/support/wallet/usage/createTrainingUsage' \
--header 'Authorization: Bearer {{apikey}}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "datasetId": "知识库 ID",
    "name": "可选，自定义订单名称，例如：文档训练-ZenMeta.docx"
}'
```
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/create' \
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/list?parentId=' \
...
```bash
curl --location --request GET 'https://ops.zenlayer.ai/api/core/dataset/detail?id=6593e137231a2be9c5603ba7' \
--header 'Authorization: Bearer {{authorization}}' \
```
...
```bash
curl --location --request DELETE 'https://ops.zenlayer.ai/api/core/dataset/delete?id=65abc8729d1448617cba5df6' \
--header 'Authorization: Bearer {{authorization}}' \
```
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/collection/create' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/collection/create/text' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "text":"xxxxxxxx",
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/collection/create/link' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "link":"https://ops.zenlayer.ai/docs/course/quick-start/",
    "datasetId":"6593e137231a2be9c5603ba7",
    "parentId": null,
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/collection/create/localFile' \
--header 'Authorization: Bearer {{authorization}}' \
--form 'file=@"C:\\Users\\user\\Desktop\\ZenMeta测试文件\\index.html"' \
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/collection/create/apiCollection' \
--header 'Authorization: Bearer opsnb-xxx' \
--header 'Content-Type: application/json' \
--data-raw '{
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/proApi/core/dataset/collection/create/externalFileUrl' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'User-Agent: Apifox/1.0.0 (https://apifox.com)' \
--header 'Content-Type: application/json' \
--data-raw '{
    "externalFileUrl":"https://image.xxxxx.com/ZenMeta-dev/%E6%91%82.pdf",
    "externalFileId":"1111",
...
**4.8.19+**
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/collection/listV2' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "offset":0,
...
**4.8.19-(不再维护)**
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/collection/list' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "pageNum":1,
    ...
    "data": {
        "list": [
            ...
            },
            {
                ...
                "type": "link",
                "name": "快速上手 | ZenMeta",
                "rawLink": "https://ops.zenlayer.ai/docs/course/quick-start/",
...
```bash
curl --location --request GET 'https://ops.zenlayer.ai/api/core/dataset/collection/detail?id=65abcfab9d1448617cba5f0d' \
--header 'Authorization: Bearer {{authorization}}' \
```
...
```bash
curl --location --request PUT 'https://ops.zenlayer.ai/api/core/dataset/collection/update' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
...
```bash
curl --location --request DELETE 'https://ops.zenlayer.ai/api/core/dataset/collection/delete?id=65aa2a64e6cb9b8ccdc00de8' \
--header 'Authorization: Bearer {{authorization}}' \
```
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/data/pushData' \
--header 'Authorization: Bearer apikey' \
--header 'Content-Type: application/json' \
--data-raw '{
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/data/v2/list' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "offset": 0,
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/data/list' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "pageNum":1,
...
```bash
curl --location --request GET 'https://ops.zenlayer.ai/api/core/dataset/data/detail?id=65abd4b29d1448617cba61db' \
--header 'Authorization: Bearer {{authorization}}' \
```
...
```bash
curl --location --request PUT 'https://ops.zenlayer.ai/api/core/dataset/data/update' \
--header 'Authorization: Bearer {{authorization}}' \
--header 'Content-Type: application/json' \
--data-raw '{
...
```bash
curl --location --request DELETE 'https://ops.zenlayer.ai/api/core/dataset/data/delete?id=65abd4b39d1448617cba624d' \
--header 'Authorization: Bearer {{authorization}}' \
```
...
```bash
curl --location --request POST 'https://ops.zenlayer.ai/api/core/dataset/searchTest' \
--header 'Authorization: Bearer opsnb-xxxxx' \
--header 'Content-Type: application/json' \
--data-raw '{
    "datasetId": "知识库的ID",
    "text": "导演是谁",

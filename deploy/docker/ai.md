...
| GPU | 显存  | 数量 | 模型                                     |
|-----|-----|----|----------------------------------------|
| L20 | 48G | 2  | Qwen3-30B-A3B-Thinking-2507-FP8        |
| L20 | 48G | 2  | Qwen3-30B-A3B-Instruct-2507-FP8        |
| A40 | 48G | 1  | MiMo-VL-7B-RL-2508                     |
| A40 | 48G | 1  | Qwen3-Embedding-8B / Qwen3-Reranker-8B |
| T4  | 16G | 4  | mineru                                 |
...
```shell[ai-new.md](../../../../Downloads/ai-new.md)
# lmdeploy
...
```shell
# vllm
CUDA_VISIBLE_DEVICES=0 nohup vllm serve /model/Qwen3-VL-32B-Instruct-FP8 --port 38000 --api-key sk-5NQ8OTOo8e1rMBm224590f72E8A2415692432cA3B2646d4e  -tp 4 --limit-mm-per-prompt '{"image":8}'  --served-model-name Qwen3-VL-32B-Instruct-FP8  --seed 538 --max-num-seqs 128 --gpu-memory-utilization 0.95  --async-scheduling --max-num-seqs 32 --max-model-len 131072 --limit-mm-per-prompt.video 0  &> qwen3-vl-instruct.log &
```
...
```shell
# vllm
CUDA_VISIBLE_DEVICES=0,1 nohup vllm serve  /model/Qwen3-Embedding-8B   --port 28681 --api-key "sk-SwKcDv111IateoguD82706747f034818984cD731De0a13Ab" --served-model-name "Qwen3-Embedding-8B" --task embed  &> embedding.log &
